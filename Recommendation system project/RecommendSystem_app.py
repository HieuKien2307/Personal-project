...
def getdata():
    games_df = pd.read_csv('C:\dataset\Games_dataset.csv', index_col=0)
    similarity_df = pd.read_csv('C:\dataset\sim_matrix.csv', index_col=0)
...
st.sidebar.markdown('__Nintendo Switch game recommender__  \nAn app by '
                    '[Hieu Kien Trinh Nguyen]')
st.sidebar.image('C:\Recommendation system project\nintendo.png', use_column_width=True)
